...
const version=ref('...');
const loadStats=async()=>{try{const[s,r,l]=await Promise.all([api.get('/stats'),api.get('/health'),api.get('/logs?limit=20')]);Object.assign(stats,s.data);logList.value=l.data||[];if(r.data?.version)version.value=r.data.version}catch(e){}};
