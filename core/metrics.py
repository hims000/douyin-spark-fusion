...
COOKIE_VALID = Gauge(
    "douyin_cookie_valid", "Whether the douyin cookie is valid (1=valid, 0=invalid)"
)
API_REQUEST_DURATION = Histogram(
    "http_request_duration_seconds", "API request duration", ["method", "endpoint"]
)
